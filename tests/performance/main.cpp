...
int main(int argc, char **argv)
{
    ...
    const size_t dataCount = 500000000;
    ...
    for (size_t i = 0u; i < 500000000; i++) {
        auto path = "/" + std::to_string(i);
        accessor->setValue(path, path);
    }
    auto end = steady_clock::now();
    auto d = duration_cast<seconds>( end - start ).count();
    cout << "Inserting " + to_string(dataCount) << " values: " << d << "milliseconds" << endl;
    cout << "average: " << duration_cast<milliseconds>(end - start).count() << " ms" << endl << endl;
    ...
    cout << "Getting " + to_string(dataCount) << " values: " << d << "milliseconds" << endl;
    cout << "average: " << duration_cast<milliseconds>(end - start).count() << " ms" << endl << endl;
    ...
    d = duration_cast<seconds>( end - start ).count();
    cout << "Removing " + to_string(dataCount) << " values: " << d << "milliseconds" << endl;
    cout << "average: " << duration_cast<milliseconds>(end - start).count() << " ms" << endl << endl;
